...
/* 1) Retrieve Data from Flask Back-end */
let uri = "http://localhost:9090/api/blogs";
let h = new Headers();
...
/* 7) Function and Event Listner (high order function) and Event Handler (callback function) */
